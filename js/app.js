...
var getInspiration = function(topAnswerersTag) {
	...
	$.ajax({
		url: "https://api.stackexchange.com/2.2/tags/" + topAnswerersTag + "/top-answerers/all_time",
		data: request,
		dataType: "jsonp",
		type: "GET",
	})
...
$(document).ready( function() {
	...
	$('.inspiration-getter').submit( function(e){
		e.preventDefault();
		$('.results').html('');
		var topAnswerersTag = $(this).find("input[name='answerers']").val();
		getInspiration(topAnswerersTag);
	});
});
